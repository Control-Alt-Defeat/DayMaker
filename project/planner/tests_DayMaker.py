...
def runTests(dayList):
    ...
    my_json = DayMaker.natLangQuery(search_term, my_filter, 100, 1, DayMaker.rules.CBUS_COORD, {'start_time':2400, 'end_time':1000, 'date':DayMaker.datetime.datetime.today()}, 'bars')
